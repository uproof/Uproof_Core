        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-6 border-t mt-4 border-gray-100/50 animate-fade-in">
            <div className="flex flex-col space-y-1">
              ...
              <Link href="/services/seasonal" prefetch={false} className="text-gray-900 hover:text-primary-600 transition-colors font-semibold px-4 py-3 hover:bg-primary-50 rounded-lg">
                {t('seasonalServices') || 'Seasonal services'}
              </Link>
