...
export const NAV_ITEMS: NavItem[] = [
  ...
  { path: 'procurement', label: 'Materials plan', labelLv: 'Materiālu saraksts', group: 'internal', printable: true },
  { path: 'materials', label: 'Purchase list', labelLv: 'Iepirkumu saraksts', group: 'internal', printable: true },
