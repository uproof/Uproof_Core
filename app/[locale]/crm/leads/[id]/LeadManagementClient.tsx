        ...
        <div className="space-y-6">
          ...
          <Card variant="outlined" hover={false} className="border-sky-100 bg-white">
            <div className="mb-4">
              ...
              {!isSalesScope ? <a href={`/${locale}/estimator/${encodeURIComponent(lead.id)}`} className="mt-3 inline-flex items-center rounded-xl border border-sky-200 bg-white px-3 py-2 text-sm font-semibold text-sky-700 hover:bg-sky-50">Open Estimator Engine</a> : null}
            </div>
