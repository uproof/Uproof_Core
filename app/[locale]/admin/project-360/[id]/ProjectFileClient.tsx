    ...
    <div className="min-h-screen bg-slate-50 px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-5 space-y-3">
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4"><Link href={`/${locale}/admin/project-360/${encodeURIComponent(project.leadId)}/workbook`} className="inline-flex rounded-lg bg-sky-700 px-4 py-2 text-sm font-semibold text-white">Atvērt pilno workbook estimator</Link></div>
