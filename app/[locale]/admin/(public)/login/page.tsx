...
export default function AdminLogin() {
  ...
  const copy =
    locale === 'nl-BE'
      ? {
          title: 'UpRoof Admin',
          subtitle: 'Superadmin login voor CMS en CRM',
          emailLabel: 'E-mail',
      ...
      : locale === 'en'
        ? {
            title: 'UpRoof Admin',
            subtitle: 'Superadmin login for CMS and CRM',
          emailLabel: 'Email',
        ...
        : {
            title: 'UpRoof Admin',
            subtitle: 'Superadmin pieteikšanās CMS un CRM',
          emailLabel: 'E-pasts',
  ...
  const targetPath = typeof redirectTo === 'string' && redirectTo.startsWith('/') ? redirectTo : `/${locale}/admin`;
